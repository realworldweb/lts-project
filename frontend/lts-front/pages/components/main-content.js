...
export default function MainContent(props) {
	...
	, [search]);
        ...
        else
        {
          ...
          const  {name, price, description} = el;
              ...
              <img className={Styles.searchImg} src='/dest-img.png' alt='destination image'/>
	...
	return (
		<div
			className={`container-fluid d-flex flex-column position-relative mx-auto justify-content-center align-items-center ${Styles.resultsContainer}`}
		>
			{search && data.current? (
                <>
                <h1 className='d-block text-center font-weight-bolder'>Search Results</h1>
				<div className={`d-flex position-relative justify-content-center flex-wrap ${Styles.resultsCard}`}>
