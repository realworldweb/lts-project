...
export default function AdvSearch() {
 ...
 const handleChange = () => {/*do something*/}
  ...
  return (
  <form className={`form container-fluid p-4 position-relative justify-content-center align-items-center border border-dark bg-white ${Styles.advSearch}`}>
   <div className="form-group d-block position-relative w-100">
    <select className="form-control rounded-pill" placeholder="location" value={location} onChange={handleChange}>
    <option className="form-text text-muted" disabled>{location}</option>
    </select>
  </div>
  <div className="form-group d-block position-relative w-100">
    <select className="form-control rounded-pill" placeholder="location" value={depAirport} onChange={handleChange}>
    <option className="form-text text-muted" disabled>{depAirport}</option>
    </select>
  </div>
  <div className="form-group d-block position-relative w-100">
    <select className="form-control rounded-pill" placeholder="location" value={arrAirport} onChange={handleChange} >
  ...
  <div className="form-group">
    <select className="form-control rounded-pill" placeholder="location" value={depDate} onChange={handleChange} >
  ...
  <div className='col-6'>
  <div className="form-group">
    <select className="form-control rounded-pill" placeholder="location" value={retDate} onChange={handleChange} >
  ...
  <div className='col-6'>
  <div className="form-group">
    <select className="form-control rounded-pill" placeholder="location" value={adtPassengers} onChange={handleChange} >
  ...
  <div className='col-6'>
  <div className="form-group">
    <select className="form-control rounded-pill" placeholder="location" value={chdPassengers} onChange={handleChange} >
    <option className="form-text text-muted"  disabled>{chdPassengers}</option>
    </select>
  </div>
  </div>
  </div>
  <button type="submit" className="btn btn-primary rounded-pill d-block w-25 mx-auto">Search</button>
  </form>
  )
}